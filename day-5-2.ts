...
function resolve() {
    ...
    let diagonalRight = lines.filter((line) => line.x1 - line.x2 == line.y1 - line.y2)
    let diagonalLeft = lines.filter((line) => line.x1 - line.x2 == line.y2 - line.y1)
